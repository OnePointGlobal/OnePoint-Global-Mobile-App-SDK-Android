...
import static com.opg.sdk.OPGSDKConstant.ACTIVITY_START;
import static com.opg.sdk.OPGSDKConstant.ACTIVITY_STOP;
import static com.opg.sdk.OPGSDKConstant.ALERT;
import static com.opg.sdk.OPGSDKConstant.BEEP;
import static com.opg.sdk.OPGSDKConstant.BUTTON_INDEX;
import static com.opg.sdk.OPGSDKConstant.CONFIRM;
import static com.opg.sdk.OPGSDKConstant.INPUT_1;
import static com.opg.sdk.OPGSDKConstant.PROGRESS_START;
import static com.opg.sdk.OPGSDKConstant.PROGRESS_STOP;
import static com.opg.sdk.OPGSDKConstant.PROGRESS_VALUE;
import static com.opg.sdk.OPGSDKConstant.PROMPT;
...
public class Notification extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        else if (action.equals(ACTIVITY_START)) {
            this.activityStart(args.getString(0), args.getString(1));
        }
        else if (action.equals(ACTIVITY_STOP)) {
            this.activityStop();
        }
        else if (action.equals(PROGRESS_START)) {
            this.progressStart(args.getString(0), args.getString(1));
        }
        else if (action.equals(PROGRESS_VALUE)) {
            this.progressValue(args.getInt(0));
        }
        else if (action.equals(PROGRESS_STOP)) {
            this.progressStop();
        }
        else {
            return false;
                        ...
                        dlg.setNegativeButton(buttonLabels.getString(0),
                            new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    try {
                                        result.put(BUTTON_INDEX,1);
                                        result.put(INPUT_1, promptInput.getText().toString().trim().length()==0 ? defaultText : promptInput.getText());
